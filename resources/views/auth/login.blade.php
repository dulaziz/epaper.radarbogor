...
<section class="h-screen bg-gray-100 flex items-center justify-center">
    <div class="w-96 bg-gray-50 border-t-4 border-t-emerald-500 rounded-lg p-6 shadow-md">
        <h1 class="mb-8 text-2xl font-semibold text-gray-700">Login Form</h1>
    <form>
        <div class="mb-6">
        ...
        <p class="text-sm text-center">Not a member? <a href="" class="text-blue-500 hover:underline">Register here</a></p>
